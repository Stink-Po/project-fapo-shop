...
function config() {
    ...
    $config.loadingBars_border_color = '#f07d00';
    $config.loadingBars_color =  '#f07d00';
    $config.loadingBars_background_color =  '#f4f4f4';

    // Countdown Timer
    const newCode =  document.getElementById('otp-link').getAttribute('data-url');
    $config.timer_color = '#f07d00';
    $config.timer_font_weight = 700;
    $config.timer_font = 'yekan-bakh';
    $config.timer_font_size = 14;
        $config.endtime_message = "<a href='"+ newCode +" ' class='main-color-one-text'>درخواست کد جدید</a>";
